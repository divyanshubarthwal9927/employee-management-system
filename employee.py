...
lblinfo=Label(Tops,font=('arial',45,'bold'),text="Employee Payment Management system ",bd=10,fg="Red")
...
def enterinfo():
  ...
  txtpayslip.insert(END,"Designation :\t\t"+Designation.get()+"\n\n")
...
lblEmployer=Label(fla,text="Designation",font=('arial',16,'bold'),bd=20,fg="red",bg="white").grid(row=1,column=0)
lblNINumber=Label(fla,text="Emp Id",font=('arial',16,'bold'),bd=20,fg="red",bg="white").grid(row=1,column=2)
...
etxemployer=Entry(fla,textvariable=Designation,font=('arial',16,'bold'),bd=16,width=22,justify='left')
